...
only_one.add_argument(
    "-html",
    "-webversion",
    help="outputs the result as HTML5",
    action="store_true",
    dest="html",
)
only_one.add_argument(
    "-j", "-json", help="outputs the result as JSON", action="store_true", dest="json"
)
only_one.add_argument(
    "-t", "-txt", help="outputs the result as a text", action="store_true", dest="text"
)
parser.add_argument(
    "-qty",
    "-quantity",
    help="how many results shoud be processed, defaults to 10 results",
    action="store",
    default=10,
    dest="qty",
    type=int,
...
parser.add_argument(
    "-d",
    "-delay",
    help="how long to wait between searches in seconds, defaults to 1",
    action="store",
    default=1,
    dest="delay",
    type=int,
